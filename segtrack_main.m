...
tracksFast = trackLabelStackKalmanLAP(labelStackSeeded, ...
    'MaxDist', 5, ...
    'MaxMissed', 4, ...
    'MinTrackLength', 100, ...
    'Verbose', true);
...
%% Show the tracks in 3D for QA
viewTracks3D(tracksClosed, ...
    'MinLength', 20, ...
    'ScaleZ', 1, ...
    'ShowPoints', true);

%% Compare overlay of tracks labels
viewTrackOverlaySliceBySlice(imgPre, labelStackSeeded, tracksClosed);
